    ...
    public class OllamaEmbeddingsOutputConverter : JsonConverter<object>
    {
        ...
        public override void Write(Utf8JsonWriter writer, object value, JsonSerializerOptions options)
        {
            ...
            switch (value)
            {
                ...
                // Handle IEnumerable<float> (single embedding, generic)
                ...
                // Handle IEnumerable<IEnumerable<float>> (multiple embeddings, generic)
        ...
        {
            // Check if this is actually a nested enumerable disguised as IEnumerable<float>
