namespace SharpAI.Database.Postgresql
{
    ...
    /// <summary>
    /// PostgreSQL database driver. Provides PostgreSQL dialect DDL and paging.
    /// </summary>
    public class PostgresqlDatabaseDriver : DatabaseDriverBase
    {
        ...
        {
            get { return DatabaseTypeEnum.Postgresql; }
        }
        ...
        {
            int port = Settings.Port > 0 ? Settings.Port : 5432;
            string connectionString =
                "Host=" + Settings.Hostname + ";Port=" + port + ";Database=" + Settings.DatabaseName +
            ...
            get
            {
                return new List<SchemaMigration>
                {
                    ...
                    new SchemaMigration(2, "Request history schema", new List<string>
                    {
                        ...
                        "method TEXT, path TEXT, url TEXT, statuscode INTEGER, durationms DOUBLE PRECISION, sourceip TEXT, " +
                        "requestheadersjson TEXT, requestbody TEXT, requestbodybytes BIGINT, requestbodytruncated INTEGER, " +
                        "responseheadersjson TEXT, responsebody TEXT, responsebodybytes BIGINT, responsebodytruncated INTEGER, " +
